...
const Hero = () => {
 ...
 <h1 className='text-[40px] sm:text-[56px] text-[#101727] font-extrabold sm:leading-[84px]'>Supercharge Your Digital Workflow</h1>
        <p className='text-[#627382] '>Access premium AI tools, design assets, templates, and productivity software—all in one place. Start creating aster today.<br></br> Explore Products </p>
